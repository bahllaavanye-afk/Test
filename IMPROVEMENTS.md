...
- [ ] **[P1] Overfit killers in strategy promotion** — deflated Sharpe ratio + probability-of-backtest-overfitting (PBO) gates before a strategy is promoted/scaled (Bailey & López de Prado line of work). We only do walk-forward today.
