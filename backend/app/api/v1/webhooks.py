...
# Constants
ENV_SECRET = "TRADINGVIEW_WEBHOOK_SECRET"
ERROR_DISABLED_DETAIL = "TradingView webhook receiver disabled — set TRADINGVIEW_WEBHOOK_SECRET."
ERROR_BODY_JSON = "Body must be a JSON object."
...
LOG_EVENT_NAME = "tradingview alert received"
...
async def recent_tradingview_alerts(limit: int = DEFAULT_RECENT_LIMIT) -> dict:
    ...
    limit = max(MIN_LIMIT, min(limit, MAX_RECENT_ALERTS))
