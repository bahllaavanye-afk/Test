...
class CPCV:
    ...
    Parameters:
        n_splits: number of time-series folds (e.g., 6 gives C(6,1)=6 test periods)
    ...
    def validate(
        ...
        Returns:
            dict with:
                ...
                is_overfit: True if DSR < OVERFIT_THRESHOLD × mean_sharpe
        """
        ...
        if not sharpes:
            ...
            is_overfit = dsr < OVERFIT_THRESHOLD * mean_sr
