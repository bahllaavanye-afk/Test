...
def walk_forward(
    ...
    # Pre‑compute the start indices for each window to avoid repeated arithmetic
    start_indices = range(train_bars, len(prices) - test_bars + 1, test_bars)
    ...
    for i in start_indices:
        ...
        try:
            ...
            # Preserve equity for the next window
