...
class TradeStationBroker(AbstractBroker):
    def __init__(self, client_id: str, client_secret: str, account_id: str, paper: bool = True):
        ...
        # Reuse a single AsyncClient for the lifetime of the broker to avoid
        # repeated TCP handshakes and connection pool creation.
    ...
    async def _get_token(self) -> str:
        ...
        # Subtract a safety margin to refresh before actual expiry.
    ...
    def build_option_order_body(
        ...
        *,
        ...
        body["TradeAction"] = "BUYTOOPEN" if opening else "SELLTOOPEN"
        return body
