...
P_VALUE_DISPLAY_PRECISION: int = 4
IMPROVEMENT_DISPLAY_PRECISION: int = 4
T_STAT_DISPLAY_PRECISION: int = 4
P_VALUE_FULL_PRECISION: int = 6

LOG_EVENT_COMPARISON_COMPLETE: str = "Comparison complete"
LOG_KEY_STRATEGY: str = "strategy"
LOG_KEY_MANUAL_SHARPE: str = "manual_sharpe"
LOG_KEY_ML_SHARPE: str = "ml_sharpe"
LOG_KEY_P_VALUE: str = "p_value"
...
class StrategyComparisonEngine:
    async def run_comparison(
        ...
        logger.info(
            LOG_EVENT_COMPARISON_COMPLETE,
            **{
                LOG_KEY_STRATEGY: strategy_name,
                LOG_KEY_MANUAL_SHARPE: manual_metrics.sharpe,
                LOG_KEY_ML_SHARPE: ml_metrics.sharpe,
                LOG_KEY_P_VALUE: round(p_val, P_VALUE_DISPLAY_PRECISION),
            },
        )
        ...
        return ComparisonResult(
            ...
            ml_improvement_sharpe=round(improvement, IMPROVEMENT_DISPLAY_PRECISION),
            t_statistic=round(float(t_stat), T_STAT_DISPLAY_PRECISION),
            p_value=round(float(p_val), P_VALUE_FULL_PRECISION),
