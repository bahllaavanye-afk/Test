...
PVAL_LOG_ROUND_PRECISION: int = 4
PVAL_RETURN_ROUND_PRECISION: int = 6
...
class StrategyComparisonEngine:
    async def run_comparison(
        ...
        logger.info(
            ...
            p_value=round(p_val, PVAL_LOG_ROUND_PRECISION),
        )
        ...
        return ComparisonResult(
            ...
            p_value=round(float(p_val), PVAL_RETURN_ROUND_PRECISION),
