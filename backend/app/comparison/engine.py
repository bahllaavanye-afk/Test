...
class StrategyComparisonEngine:
    async def run_comparison(
        ...
        initial_equity : float, optional
            Starting equity for the backtest, default 100,000.

        Returns
        -------
        ComparisonResult
            Dataclass containing backtest metrics and statistical comparison.
        ...
        # Ensure the series have compatible indexes
