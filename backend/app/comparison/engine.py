...
class StrategyComparisonEngine:
    ...
    def _determine_winner(
        ...
        return WINNER_ML if ml_metrics.sharpe > manual_metrics.sharpe else WINNER_MANUAL
    ...
    def _log_comparison(
        ...
        logger.info(
            ...
            **{
                ...
                LOG_P_VALUE_FIELD: round(p_value, P_VALUE_ROUND),
            },
        )
    ...
    async def run_comparison(
        ...
        # Benchmark data
        benchmark_curves, benchmark_stats = await self._fetch_benchmark(start_date, end_date)
        ...
        # Improvement and winner determination
        improvement = ml_metrics.sharpe - manual_metrics.sharpe
        winner = self._determine_winner(manual_metrics, ml_metrics, improvement)

        # Logging
        self._log_comparison(strategy_name, manual_metrics.sharpe, ml_metrics.sharpe, p_val)
