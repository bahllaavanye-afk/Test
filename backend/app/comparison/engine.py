...
class StrategyComparisonEngine:
    async def run_comparison(
        ...
        prices : pd.Series
            Price series for the underlying instrument.
        strategy_name : str
            Human‑readable name of the strategy.
        symbol : str
            Ticker symbol of the instrument.
        interval : str
            Timeframe of the data (e.g., "1h", "daily").
        start_date : date
        ...
        -------
        ComparisonResult
            Dataclass containing the comparison metrics and statistical test results.
        ...
        # Ensure all series share the same index for alignment
        if not manual_signals.index.equals(ml_signals.index) or not manual_signals.index.equals(prices.index):
            raise ValueError(
                "manual_signals, ml_signals, and prices must share the same index."
            )
