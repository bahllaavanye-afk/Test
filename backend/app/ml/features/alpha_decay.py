...
class AlphaDecayTracker:
    ...
    def compute_ic_profile(
        ...
        for h in self.HORIZONS:
            ...
            # Simple P&L estimate for logging purposes
            pnl_estimate = float((s * r).sum())
        ...
        logger.info(
            ...
            extra={
                ...
                "horizons_computed": len(ics),
                "ic_0": getattr(profile, "ic_0", None),
                "half_life_hours": getattr(profile, "half_life_hours", None),
