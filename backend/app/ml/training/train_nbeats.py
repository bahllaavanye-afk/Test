...
async def train(
    ...
    experiment_name: str = "nbeats_default",
    seq_len: int = 60,
    layer_size: int = 256,
    n_layers: int = 4,
    trend_degree: int = 3,
    ...
    # N-BEATS flattens (batch, seq_len, n_features) → (batch, seq_len * n_features)
    ...
    logger.info("N-BEATS training complete", **results)
    return results
...
if __name__ == "__main__":
    ...
    parser.add_argument("--name", default="nbeats_run")
