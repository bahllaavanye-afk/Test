...
class Bot(Base, TimestampMixin):
    ...
    def log_metrics(self, signal_count: int, execution_time: float, pnl: float) -> None:
        """Log key execution metrics for the bot.

        Args:
            signal_count: Number of signals processed during the run.
            execution_time: Duration of the run in seconds.
            pnl: Profit and loss generated in the run (positive for profit, negative for loss).
        """
        logger.info(
