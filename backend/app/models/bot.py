...
# Set up module-level logger for structured monitoring
...
class Bot(Base, TimestampMixin):
    ...
    def log_execution(self, signal_count: int, execution_time: float, pnl: float) -> None:
        """Log key execution metrics for monitoring.

        Args:
            signal_count: Number of signals processed in the run.
            execution_time: Total time taken for the run (seconds).
            pnl: Profit and loss generated in the run.
        """
        logger.info(
