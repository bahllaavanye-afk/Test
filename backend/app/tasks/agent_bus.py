            ...
            try:
                ...
                for stream_key, messages in results:
                    ...
                    for msg_id, fields in messages:
                        ...
                        # Deserialize fields back to dict once per message
                        data: dict = {}
                        ...
                        coros = [
                            self._safe_invoke(handler, topic, data)
                            for handler in handlers
                        ]
                        # Await all, collecting exceptions inside _safe_invoke
