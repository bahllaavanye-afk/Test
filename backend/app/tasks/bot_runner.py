...
# Constants
FIRST_RUN_DELAY_MIN = 30
FIRST_RUN_DELAY_MAX = 150
DEFAULT_INTERVAL = "1h"
...
def _first_run_time() -> datetime:
    ...
    """
    return datetime.now(timezone.utc) + timedelta(seconds=random.uniform(FIRST_RUN_DELAY_MIN, FIRST_RUN_DELAY_MAX))
