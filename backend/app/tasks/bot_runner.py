...
class BotRunner:
    ...
    async def _run_bot(self, bot_id: str) -> None:
        ...
        try:
            ...
            try:
                ...
                # If not a UUID, we still accept it, but ensure it's a string
                pass
    ...
    async def reschedule(self, bot: "Bot") -> None:
        ...
        if bot.trigger is not None and not isinstance(bot.trigger, dict):
            raise ValueError("bot.trigger must be a dict if provided")
